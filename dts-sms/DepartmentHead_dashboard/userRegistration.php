                       ...
                       <div class="col-md-6" style="margin-top: -5%;">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="usertype" value="Department Head"/> Department Head <br>
                                      <input class="form-check-input" type="radio" name="usertype" value="Employee"/> Employee
