...
$department = $fname = $lname = $uname = $password = $confirm_password = $phonenumber= '';
    ...
    $query = $conn -> prepare("INSERT INTO register (department) VALUES (:department)");
    ...
    {   
        ...
        $query = "INSERT INTO register (department, firstname, lastname, email, password, confirm_password, num) VALUES ('$department', '$fname', '$lname', '$uname', '$pass1', '$pass2', '$phone')";
