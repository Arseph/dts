            ...
            <input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
                ...
                <div class="wrapper" style="margin-left: 5%">
                    <div class="row form-group" style="margin-bottom: 2%">
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="usertype" name="usertype" class="form-control rounded-0" value="<?php echo $row['usertype']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;">
                                <option selected="true" hidden><?php echo $row['usertype']; ?></option>
                                <?php echo $option2;?>
                            </select>
                        </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control rounded-0" name="username" value="<?php echo $row['username']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                    </div>
                    <div class="col-sm-6">
                        <label style="font-size: 13px;">Name:</label>
                        <input type="text" class="form-control rounded-0" name="fullname" value="<?php echo $row['fullname']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                    </div>
                </div>
                <br>
                ...
                <div class="row form-group" style="margin-bottom: 2%">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control rounded-0" name="email" value="<?php echo $row['email']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                    </div>
                    <div class="col-sm-6">
                        <label style="font-size: 13px;">Date of birth:</label>
                        <input type="text" class="form-control rounded-0" id="bday" name="bday" value="<?php echo $row['bday']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                    </div>
                </div>
                <div class="row form-group" style="margin-bottom: 2%">
                    <div class="col-sm-6">
                        <label style="font-size: 13px;">Phone Number:</label>
                        <input type="text" class="form-control rounded-0" name="phone_number" value="<?php echo $row['phone_number']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                    </div>
                    <div class="col-sm-6">
                        <label class="control-label modal-label" style="font-size: 13px;">Department:</label>
                        <select id="typeD" name="department" class="form-control rounded-0" value="<?php echo $row['department']; ?>" style="font-size: 13px;margin-top: -3%; width: 90%; border: 0.5px solid lightgrey;" readonly>
                ...
                <!--<div class="row form-group" style="margin-bottom: 2%">
                    <div class="col-sm-6" style="margin-bottom: 2%">
                        ...
                        <textarea class="form-control rounded-0" name="address" placeholder="Write your complete address" style="height:142px; font-size: 12px; width: 200%; border: 0.5px solid lightgrey;" required><?php echo $row['address']; ?></textarea> 
                    </div>
                </div>-->
                </div>
            </div> 
