...
<div class="card" style="width:950px; margin-top: -0.6%; margin-left: 23.5%;">
  <div class="card-header" style="height:  40px; font-size: 13px; text-align: left; font-weight: 600; color: #747272; background-color: white;">
    List of Actions
      <a href="addActionType.php" class="" style="float: left; margin-top: -20px; width: 20%; height: 33px;margin-left: 84%; font-size: 12px; color: #747272;"><i class="fas fa-book"></i>&nbsp;Create Document Type</a>
  </div>    
        ...
        <table id="userTbl" class="responsive-table table-hover table-striped table-sm m-0" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php
              ...
              $sql = "SELECT * from tbl_action where department = '$department'";
             ...
             while($row = mysqli_fetch_array($resTab)){
                ...
                "<tr style='font-size: 12px'>
                  <td class=''>
                    <input type='checkbox' class='delete_checkbox' name='delete_id' value=".$row["id"]." />
                  </td>
