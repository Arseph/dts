...
INSERT INTO `file_upload` (`id`, `user`, `tracking_no`, `file_name`, `file_description`, `select_date`, `department`, `attach_file`, `type_document`) VALUES
...
(161, 'employee12', '9778696864', 'Ako si aron', 'ngingi', '2021-10-21', '', '3803-Book1.xlsx', 'Hay'),
(162, 'employee12', '3553742674', 'Ako si aron', 'ddd', '2021-10-21', '', '7164-Book1.xlsx', 'Hay'),
(163, 'employee12', '6517161204', 'New file', 'sadsdasd', '2021-10-21', '', '3274-batchUpload.php', 'Hay'),
(164, 'maghanoy123', '4129221519', 'New file ni maghanoy', 'sdadasd', '2021-10-21', '', '3385-documenttrackingsystem_db.sql', 'New type');
...
(28, '', 'Kyla', 'Marie', NULL),
(29, '', 'Ngi', 'Ngi', NULL),
(30, 'BACOMM Department', 'Hay', 'Naku', NULL),
(31, 'SSW Department', 'New type', 'asdf', NULL);
...
--
ALTER TABLE `file_upload`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=165;
