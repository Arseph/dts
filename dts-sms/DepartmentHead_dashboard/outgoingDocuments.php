    ...
    <!--<input type="submit" name="delete_all" value="Remove" class="btn btn-danger btn-xs" style="font-size: 12px; width: 8%; margin-bottom: 10px; margin-left: 4px;">-->
        ...
        <table id="userTbl" class="responsive-table table-hover table-striped table-sm" width="100%">
          <thead style=" color: #2B2B2B; font-size: 12px; border-bottom: 1.5px solid #A8A8A8;">
            <tr class="myHead">
              <th style="width: 11%; text-align: center;"><i class="fa fa-search" style="color: gray;"></i> &nbsp;TRACKING NO.</th>
              <th style="width: 13%; text-align: center;"><i class="fa fa-file" style="color: gray;"></i> &nbsp;FILE NAME</th>
              <!--<th style="width: 18%; text-align: center;">DETAILS</th>-->             
              <th style="width: 13%; text-align: center;"><i class="fa fa-envelope-open-text" style="color: gray;"></i> &nbsp;MESSAGE/DESCRIPTION</th>
              <th style="width: 13%; text-align: center;"><i class="fas fa-file" style="color: gray;"></i> &nbsp;DOCUMENT TYPE</th>
              <th style="width: 15%; text-align: center;"><i class="fa fa-calendar" style="color: gray;"></i> &nbsp;DATE/TIME RELEASED</th>
              <th style="width: 5%; text-align: center;">MORE</th>
            </tr>
          </thead>
          <tbody>
            <?php
