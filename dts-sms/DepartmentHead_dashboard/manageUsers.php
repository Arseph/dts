...
<style>
  ...
  <div class="info">
    <b style="font-size: 15px; font-weight: 600"><div class="navbar_link"></div><a href="navbar.php" style="font-size: 15px; font-weight: 600">Dashboard</a> / Department Users</b>
  </div>
</div>
    ...
    <div class="row">
      <a href="<?php $_SERVER['PHP_SELF']; ?>" class="refresfMdl btn btn-primary" style="font-size: 12px; width: 8%; margin-top: 4px; margin-left: 10px; height: 30px"> Refresh</a>
        <form method="POST" action="add.php">
          <!---<a href="#addnew" data-toggle="modal" class="addMdl btn btn-primary" style="float: left; margin-left: 5px; font-size: 12px;"><span class="glyphicon glyphicon-plus"></span> Create User</a>
          <a href="<?php $_SERVER['PHP_SELF']; ?>" class="refresfMdl btn btn-info" style="float: left; margin-left: 15px; width: 110%; font-size: 12px;"><span class="glyphicon glyphicon-refresh"></span> Refresh</a>--->
        </form>
        <div class="form-group pull-right">
          <input type="text" class="search form-control rounded-0" placeholder="Search user's account" style="font-size: 12px; float: right; margin-right: -420%; margin-bottom: -10%; width: 150%">
        </div>
    </div>
  </div>
  ...
  <div class="row">
    <!--<div class="row" style="margin-top: -1%; margin-left: 5px;">
      ...
      <?php 
        ...
        $res = mysqli_query($conn, "SELECT * FROM register WHERE department='$department' and username!='$username' and usertype NOT IN ('Department Head')");
        ...
        <table id="userTbl" class="responsive-table table-hover table-striped table-sm m-0" width="100%">
          <thead style="background-color: #0062CC; color: white; font-size: 12px;">
            <tr class="myHead" style="height: 35px">
              ...
              <th style="width: 16%; text-align: left;">POSITION</th>
                ...
                <td style='text-align: left;'>
                    <?php 
                        if ($row['status']==0)
                        {
                           ...
                           echo '<p><img src="img/s1.png" width="50%"></p>';
                        }
                        else
                        {
                            echo '<p><img src="img/s2.png" width="50%"></p>';
                        }
                    ?>
                </td>
