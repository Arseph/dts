      ...
      <div class="side-bar" style="background-color: #0062CC">
        <div class="imgcontainer">
              ...
              <div class="menu">
                ...
                <!--<div class="item"><a href="add_document.php"><i class="fas fa-folder-plus"></i>Add New Document</a></div>-->
                <div class="item"><a href="receive_docu.php"><i class="fas fa-file-import"></i>Receiving Documents</a></div>
