          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="#" id="notifDropdown" role="button"
                ...
                <button class="btn btn-default btn-lg btn-link" style="font-size:20px; padding: 0px;" onclick="fetch_receive('seen')" data-toggle='tooltip' title='Received Documents'>
                  <span><i class="fas fa-file-download"></i></span>
                </button>
                <span class="badge badge-notify badgereceived"></span>
                <span class="hide badge badge-notify real_id"></span>
              </a>
                <div id="dropdownNotif" class="dropdown-menu dropdown-menu-right shadow animated--grow-in" style="z-index: 1;">
                  <small><b style="color: #0062CC; margin-left: 2%; font-size: 13px; font-weight: 700"><i class="fas fa-file-download"></i>&nbsp;Received Documents</b></small><br>
                  <div class="dropdown-divider" style="color: gray;"></div>
                  <div id="receiveDocument">
                  </div>
                </div>
              </li>
          </ul>
          ...
          <ul class="navbar-nav">
                <li class="nav-item dropdown no-arrow">
                  ...
                  <?php  
                    ...
                    ?>
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><img class="user" src="img/<?php echo $imageProfile; ?>" alt="Avatar">&nbsp;&nbsp;<?php echo $fullname; ?> (<?php echo $department;?> Receiving Officer)</span>
                    <?php
                   }
                  ?>
