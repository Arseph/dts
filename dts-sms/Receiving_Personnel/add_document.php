    ...
    <div class="card-body">
      <form action="add_document_code.php" method="POST" enctype="multipart/form-data" class="wrapper">
             ...
             <div class="form-inline">
              ...
              <div class="file_name ">
                <input type="text" class="form-control" name="file_name" style="font-size: 13px; width: 175%;" required>
              </div>
            </div><br>
          ...
          ?>
            ...
            <div class="form-inline">
              ...
              <div class="type_document ">
                <select id="type_document" class="form-control" name="type_document" style="width: 134%; font-size: 13px;" >
...
<!--- List of releaser ng department nila. isang releaser lang yung makita dapat dito. di dapat makita yung releasing officer ng ibang department--->
         <?php
            $conn = mysqli_connect("localhost","root","","documenttrackingsystem_db");
