...
<?php 
  ...
  if($_SERVER["REQUEST_METHOD"] == "POST")
  {
    ...
    else
    {
      ...
      $sql = "INSERT INTO file_upload (tracking_no, file_name, file_description, select_date, attach_file, type_document, created_at) VALUES ('$tracking_no', '$file_name', '$file_description', '$select_date', '$pname', '$type_document', '$created_at')";
      if(mysqli_query($conn,$sql))
      {
        #echo "Record Successfully saved";
        #$_SESSION['success'] = 'New record created!';
