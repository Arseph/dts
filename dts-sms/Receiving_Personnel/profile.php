...
<?php 
    ...
    ?>
    <img src="img/<?php echo $imageProfile; ?>" title="<?php echo $imageProfile; ?>" class="img" >
    <?php
    }
...
?>
      ...
      <div class="pl-sm-4 pl-2" id="img-section" style="margin-top: 2%"><b style="margin-left: -10%; font-size: 18px; "><?php echo $fullname; ?>
      <p style="margin-left: -10%;"><?php echo $department; ?> Receiving Officer    </p></b>
            ...
            if ($res)
            {
                if(mysqli_num_rows($res)>0){
                    while($row = mysqli_fetch_array($res)){
                        ...
                        <label class="control-label" style="font-size: 14px; margin-right: 8%">Name:</label>
                        <input style="font-size: 14px; font-weight: 500; padding: 10px; border: none; border-bottom: 1px solid gray; text-align: center; margin-right: 10%; width: 30%; background-color: white;" class="form-control rounded-0" value="<?php echo $fullname; ?>" name="updateFname" readonly></input>

                        <label class="control-label" style="font-size: 14px; margin-right: 10%;">Email:</label>
                    ...
                    <div class="frow form-group" style="margin-top: 5%;">
                        <div class="form-inline">
                        <label class="control-label" style="font-size: 14px; margin-right: 4.5%">Username:</label>
