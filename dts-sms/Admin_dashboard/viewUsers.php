          ...
          <tbody>
            <?php
              include_once('connection_db/connection.php');
               $sql = "SELECT * FROM register WHERE usertype IN ('Employee', 'Department Head', 'Releasing Officer', 'Receiving Officer') ORDER BY fullname ASC";
              ...
              while($row = $query->fetch_assoc()){
                ...
                "<tr style='font-size: 12px'>
                  ...
                  <td style='text-align: left;'>".$row['phone_number']."</td>
