...
if (isset($_POST['submitPass']))
  ...
  $password_query = mysqli_query($conn, "SELECT password from admin_account where username = '$user'");
  ...
  if ($database_password == $currentPass)
    ...
    if ($newPass == $confirmPass)
      {
      $update_pwd = mysqli_query($conn, "UPDATE admin_account set password ='$newPass' where username = '$user'");
