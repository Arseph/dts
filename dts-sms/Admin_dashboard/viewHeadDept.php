...
<style>
  ...
  <div class="info">
    <b style="font-size: 15px; font-weight: 600"><div class="navbar_link"></div><a href="users.php" style="font-size: 15px; font-weight: 600">User Setup</a> / Department Head Users</b>
  </div>
</div>
...
<div class="card shadow" style="width: 73%; margin-left: 25%; border: none; margin-top: 1% ">
  <div class="card-header" >
    <div class="row">
      ...
      <input type="text" class="search form-control" placeholder="Search user..." style="font-size: 12px; float: right; margin-right: -1%; margin-top: -3.8%;margin-bottom: -5%; width: 30%">
  </div>
          ...
          <tbody>
            <?php
              include_once('connection_db/connection.php');
               $sql = "SELECT * FROM register WHERE usertype = 'Department Head'";
              ...
              while($row = $query->fetch_assoc()){
                ...
                "<tr style='font-size: 12px'>
                  ...
                  <td>
                    <a href='#edit_".$row['id']."' class='btn btn-success btn-sm m-0' data-toggle='modal' style='font-size: 11px'><i class='fas fa-edit'></i></a>
