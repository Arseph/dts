...
<body style="background-color: #0062CC; position: fixed;">
 ...
 <!-- <div class="spinner-wrapper">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="http://localhost/dts/dts-sms/home.html">HOME <span class="sr-only">(current)</span></a>
                    </li>
    ...
    <!-- Header -->
    <header id="header" class="header" style="background-color: #0062CC;">
        <div class="header-content">
            <div class="container">
                <form method="POST" onsubmit="required()" name="form1" action="login_code.php">
                  <div class="card shadow cardClass" style="width:380px; margin-top: -4%;margin-left: 35%; border: none;">

                  <div class="card-header" style="height: 40px; background-color: #3993DE; border: none;">
                     <h6 style="text-align: center; font-size: 15px; margin-top: -1%; color: #fff; text-shadow: 2px 2px 1px #2679D3;"><i class="fas fa-user"></i> &nbsp;Admin Log in</h6>

                      <?php
                          if(isset($_SESSION['error'])){
                            ?>
                            <div class="alert text-center" style="margin-top: 3px;">
                    ...
                    <div class="card-footer" style="height: 40px; background-color: #3993DE; border: none;">
                      <a href="http://localhost/dts/dts-sms/index.php" style="text-decoration: none">
                        <h6 style="text-align: left; font-size: 13px; margin-top: -1%; font-weight: 500; color: #fff; text-shadow: 2px 2px 1px #2679D3;">Employee Log in
