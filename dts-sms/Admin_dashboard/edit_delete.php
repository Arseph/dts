<!-- Edit department types -->
<div class="modal fade" id="edit_<?php echo $row['dept_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="max-width: 42%;">
        <div class="modal-content rounded-0" style="width: 90%;">
            <div class="modal-header" style="background-color: #0062CC; height: 50px;">      
              <h4 class="modal-title" style="font-size: 15px; font-weight: 550;color: white; margin-top: -1px"><span><i class="fas fa-edit"></i></span> &nbsp; Edit Department Name</h4>
			...
			<form method="POST" action="editDepartmentFunction.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="department" value="<?php echo $row['department']; ?>" style="font-size: 13px; width: 100%; background-color: #F0F0F0;">
					</div>
				</div>
            </div> 
			</div>
            <div class="modal-footer">
                ...
                <button type="submit" name="editBtn" class="btn btn-success" style="width: 20%;margin-top: -1%; height: 35px; font-size: 13px;"><span class="glyphicon glyphicon-check"></span> Update</a>
			</form>
            </div>
...
<!-- Delete department types-->
<div class="modal fade" id="delete_<?php echo $row['dept_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content" style="border: none;">
            ...
            <div class="modal-footer" style="border: none; margin-top: -3%;">
                ...
                <a href="deleteDepartmentFunction.php?dept_id=<?php echo $row['dept_id']; ?>" class="btn btn-danger" style="font-size: 12px; width: 20%;margin-top: -1%; height: 35px; font-size: 13px; border-radius: 30px;  border: none; margin-right: 28%"> Yes</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editDT_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="max-width: 42%;">
        <div class="modal-content rounded-0" style="width: 90%;">
            <div class="modal-header" style="background-color: #0062CC; height: 50px;">      
              <h4 class="modal-title" style="font-size: 15px; font-weight: 550;color: white; margin-top: -1px"><span><i class="fas fa-edit"></i></span> &nbsp;Edit Document Types</h4>
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="margin-top: -15px; color: white; font-size: 20px">&times;</button>
             </div>
            <div class="modal-body">
            <div class="container-fluid">
...
<div class="modal fade" id="editDes_<?php echo $row['des_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="max-width: 42%;">
        <div class="modal-content rounded-0" style="width: 90%;">
            <div class="modal-header" style="background-color: #0062CC; height: 50px;">      
              <h4 class="modal-title" style="font-size: 15px; font-weight: 550;color: white; margin-top: -1px"><span><i class="fas fa-edit"></i></span> &nbsp;Edit Designation</h4>
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="margin-top: -15px; color: white; font-size: 20px">&times;</button>
             </div>
            <div class="modal-body">
            <div class="container-fluid">
            <form method="POST" action="editDepartmentFunction.php">
                <input type="hidden" class="form-control" name="des_id" value="<?php echo $row['des_id']; ?>">
                <div class="row form-group">
                    <div class="col-sm-2">
                        <label class="control-label modal-label" style="font-size: 13px;">Name:</label>
                    </div>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="designation" value="<?php echo $row['designation']; ?>" style="font-size: 13px; width: 100%; background-color: #F0F0F0;">
                    </div>
                </div>
            </div> 
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="width: 20%;margin-top: -1%; height: 35px; font-size: 13px;"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <button type="submit" name="editDesType" class="btn btn-success" style="width: 20%;margin-top: -1%; height: 35px; font-size: 13px;"><span class="glyphicon glyphicon-check"></span> Update</a>
            </form>
            </div>
...
<!-- Delete designation types-->
<div class="modal fade" id="deleteDes_<?php echo $row['des_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
        <div class="modal-content" style="border: none;">
            <div class="modal-header" style="background-color: #E60026; height: 40px">      
              <h5 class="modal-title" id="staticBackdropLabel" style="font-size: 14px; font-weight: 550; color: #F0F0F0; margin-top: -1%;"><span><i class="fas fa-trash" style="color: #F0F0F0;"></i></span> Delete Confirmation</h5>
            ...
            <div class="modal-footer" style="border: none; margin-top: -3%;">
                <button type="button" class="btn btn-secondary" data-dismiss="modal" style="font-size: 12px; width: 20%;margin-top: -1%; height: 35px; font-size: 13px; border-radius: 30px; border: none; margin-left: -28%"> No</button>
                <a href="deleteDesTypeFunction.php?des_id=<?php echo $row['des_id']; ?>" class="btn btn-danger" style="font-size: 12px; width: 20%;margin-top: -1%; height: 35px; font-size: 13px; border-radius: 30px;  border: none; margin-right: 28%"> Yes</a>
            </div>
        </div>
    </div>
</div>
