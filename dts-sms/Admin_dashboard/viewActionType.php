...
<?php  
    ...
    $list = mysqli_query($conn, "SELECT COUNT(*) as count FROM tbl_action WHERE department = '$username'");
...
<form action="editDepartmentFunction.php" method="POST">
...
<div class="card" style="width:950px; margin-top: -0.6%; margin-left: 23.5%;">
  <div class="card-header" style="height:  40px; font-size: 13px; text-align: left; font-weight: 600; color: #747272; background-color: white;">
    List of Actions
      <a href="addActionType.php" class="" style="float: left; margin-top: -20px; width: 20%; height: 33px;margin-left: 84%; font-size: 12px; color: #747272;"><i class="fas fa-book"></i>&nbsp;Create Action Type</a>
  </div>    
...
<div class="card shadow" style="width: 90%; margin-left: 5.5%; border: none; margin-top: -1px;">
  <div class="card-header" style="height:  45px;">
    ...
    <input type="submit" name="deleteAction" value="Delete" class="btn btn-danger btn-xs" style="font-size: 12px; width: 10%; margin-top: -4px; margin-left: -10px; height: 30px">
        ...
        <table id="userTbl" class="responsive-table table-hover table-striped table-sm m-0" width="100%" cellspacing="0">
          ...
          <tbody>
            <?php
              ...
              $sql = "SELECT * from tbl_action where department = '$username'";
             ...
             while($row = mysqli_fetch_array($resTab)){
                ...
                "<tr style='font-size: 12px'>
                  <td class=''>
                    <input type='checkbox' class='delete_checkbox' name='id' value=".$row["id"]." />
                  </td>
                  ...
                  <td>
                    <a href='#editAT_".$row['id']."' class='btn btn-success btn-sm' data-toggle='modal' style='font-size: 11px'>Edit</a>
                    <a href='#deleteAT_".$row['id']."' class='btn btn-danger btn-sm' data-toggle='modal' style='font-size: 11px'>Delete</a>
                  </td>
                </tr>";
