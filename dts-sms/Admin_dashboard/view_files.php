...
<div class="card shadow" style="width: 73%; margin-left: 25%; border: none; margin-top: 1%">
    <div class="card-header" style=" height: auto; ">
      <div class="row">
            <a href="#" data-target="#add_repository" class='btn btn-success btn-sm m-0' role='button' data-toggle='modal' style="float: left; margin-left: 5px; font-size: 12px;"><span class="glyphicon glyphicon-refresh"></span><i class="fas fa-folder-plus"></i> &nbsp;Add Repositories</a>
      </div>
    </div>
    <div class="card-body" style="height: auto; display: fixed;">
      <div class="row">
        <?php
          ...
          $sql = "SELECT * FROM user_repo_folder where user = '$username' and void = '0' order by folder_name ASC";
