...
<div class="info">
    <b style="font-size: 15px; font-weight: 600"><div class="navbar_link"></div><a href="navbar.php" style="font-size: 15px; font-weight: 600">Dashboard</a> / Manage Departments</b>
</div>
</div>
...
<div class="card" style="width:950px; margin-top: -0.6%; margin-left: 23.5%;">
  <div class="card-header" style="height:  40px; font-size: 13px; text-align: left; font-weight: 600; color: #747272; background-color: white;">
      ...
      <a href="viewDepartmentType.php" class="" style="float: left; margin-top: -3px; width: 15%; height: 33px;margin-left: -2px; font-size: 14px; color: #747272;"><i class="fas fa-arrow-left"></i>&nbsp;Back </a>
  </div>
...
<form method="POST" action="addDepartmentFunction.php">
      <div class="card shadow" style="width:400px; margin-top: -0.6%; margin-left: 23.5%; border-top: 3px solid #52AA36;">
        <div class="card-header" style="font-size: 13px; text-align: left; font-weight: 600; color: #747272; background-color: white;">Add Department Name</div>
        <div class="card-body" style="height: 120px;">
          <div class="form-group">
            <label for="addDepartment" style="margin-bottom: 4px; font-size: 14px;">Enter new department: </label>
            <input  class="form-control" type="text" placeholder="Enter here" name="addDepartment" id = "addDepartment" style="font-size: 12px;" required /> 
           <div id="errFirst"></div>
           </div>
