...
<div class="card shadow" style="width: 73%; margin-left: 25%; border: none; margin-top: 1% ">
  <div class="card-header" style="height:  55px;">
    <div class="row">
      ...
      <input type="text" class="search form-control rounded-0" placeholder="Search user's account" style="font-size: 12px; float: right; margin-left: 60%; margin-top: 1px;margin-bottom: -5%; width: 30%">
    </div>
            ...
            <tr style='font-size: 12px'>
                ...
                <td style='text-align: center;'>
                    <?php 
                        if ($row['status']==0)
                        {
                           echo '<p><a href="user_code.php?d_id='.$row['id'].'&status=1" class="btn0 btn-success" style="text-decoration: none;">Active</a></p>';
                        }
                        else
                        {
                            echo '<p><a href="user_code.php?d_id='.$row['id'].'&status=0" class="btn1 btn-danger" style="text-decoration: none;">Inactive</a></p>';
                        }
                    ?>
                </td>
                <?php
