...
<!-- Add New File-->
<div class="modal fade" id="upload" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
          ...
          ?>
				 <div class="row form-group">
	       			  <label  style="font-size: 13px;">Tracking Number: </label>
	       			  	<input class="form-control" name="tracking_no" value="<?php echo $tracking_no;?>" readonly="">
	      		  </div>
				 <div class="row form-group">
			       ...
			       <label style="font-size: 13px;">File Description</label>
			       	<textarea class="form-control" name="file_description" placeholder="Write a brief description of the file you've selected." style="height:100px; font-size: 13px;margin-top: -3%; width: 100%;"></textarea>
      			 </div>
      			 <div class="row form-group">
      			 	<span class="asterisk" style="color: red;">*</span>
