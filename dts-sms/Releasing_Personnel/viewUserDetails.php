        ...
        <div class="modal-content">
            ...
            <input type="hidden" class="form-control" name="id" value="<?php echo $row['id']; ?>">
                 ...
                 <div class="form-group" style="margin-bottom: -2%;">
                  ...
                  <div class="form-group" style="margin-bottom: -2%">
                        <label class="col control-label" style="font-size: 13px; width: 240px; color: #666666;">Send To:</label>
                        <label  style="font-size: 14px; font-weight: 500; margin-left: -13%; cursor: text;"> &nbsp;<?php echo $row['routedTo']; ?></label>
                  </div>

                  <!--<div class="form-group" style="margin-bottom: -2%">
                        <label class="col control-label" style="font-size: 13px; width: 240px; color: #666666;">Note:</label>
                        <label  style="font-size: 14px; font-weight: 500; margin-left: -13%; cursor: text;"> &nbsp;<?php echo $row['pleaseNote']; ?></label>
                  </div>-->

                  <div class="form-group" style="margin-bottom: -2%">
                        <label class="col control-label" style="font-size: 13px; width: 240px; color: #666666;">Action:</label>
                  ...
                  <div class="form-group" style="margin-bottom: -2%">
                        <label class="col control-label" style="font-size: 13px; width: 240px; color: #666666;">Sender Name:</label>
                        <label  style="font-size: 14px; font-weight: 500; margin-left: -13%; cursor: text;"> &nbsp;<?php echo $row['Sender']; ?></label>
                  </div>
