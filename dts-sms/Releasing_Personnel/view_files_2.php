...
<style>
  ...
  <?php require_once 'add_document_code.php'; ?>  
  <?php
    $mysqli = new mysqli('localhost', 'root', '', 'documenttrackingsystem_db') or die(mysqli_error($mysqli));
    $result = $mysqli->query("SELECT * FROM file_upload") or die($mysqli->error);
  ?>
                  ...
                  <table class="table table-striped table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        <!--<a href="crud_data.php?edit=<?php echo $row['tracking_no']; ?>"
                          class="btn btn-info">Edit</a>-->
                        <!--<a href="view.php?delete=<?php echo $row['id']; ?>"
                          class="btn btn-danger">Delete</a>-->
                          <a href="view.php?delete=<?php echo $row['id']; ?>"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
    ...
    <form action="" method="post">
     ...
     <div class="modal-body"> 
      ...
      <div class="form-group">
       ...
       <input type="file_name" name="file_name" id="file_name" class="form-control"  required>
      </div>
      <div class="form-group">
       <label>File Description:</label>
       <input type="file_description" name="file_description" id="file_description" class="form-control" required>
      </div>
      <div class="form-group">
       <label>Department:</label>
       <input type="type_document" name="type_document" id="type_document" class="form-control"  required>
      </div>   
     </div>
     <div class="modal-footer">
      ...
      .btnDelete, .btnEdit, .btnUpdate, .btnDownload{
        margin-right: 5px;
      }
      ...
      .btnDownload:hover .tooltiptext
      {
        visibility: visible;
      }
      .btnDownload:active
      {
        text-shadow: 2px 2px 8px #5CB323;
      }
      .pagination {
        float: right;
        margin: 0 0 5px;
